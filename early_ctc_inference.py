...
print("batch_size:",batch_size," num_heads:",n_heads," num_encoder_layers:", n_encoder_layers,"vocab_size:",dec_voc_size,"data_loader_len:",len(data_loader),"DEVICE:",device) 
...
def evaluate(model):
    ...
    path = os.getcwd()+'/trained_model/early_exit_ctc/'

    model = avg_models(model, path,25,28)        
    model.eval()
