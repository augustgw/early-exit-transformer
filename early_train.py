...
'''
odel = Early_encoder(src_pad_idx=src_pad_idx,
                    n_enc_replay=n_enc_replay,
                    d_model=d_model,
                    enc_voc_size=enc_voc_size,
                    dec_voc_size=dec_voc_size,
...
def run(total_epoch, best_loss):
    ...
    prev_loss = 9999999
    nepoch = -1
    moddir=os.getcwd()+'/trained_model/early_exit/'
