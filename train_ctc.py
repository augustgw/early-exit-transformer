...
from data import *
from models.model.transformer import CTC_Self_Attention
...
model = CTC_Self_Attention(src_pad_idx=src_pad_idx,
...
print("batch_size:",batch_size," num_heads:",n_heads," num_encoder_layers:", n_encoder_layers," num_decoder_layers:", " optimizer:","NOAM[warmup ",warmup, "]","SOS,EOS,PAD",trg_sos_idx,trg_eos_idx,trg_pad_idx,"dec_voc_size:",dec_voc_size, "data_loader_len:",len(data_loader),"DEVICE:",device) 
...
def run(total_epoch, best_loss):
    ...
    prev_loss = 9999999
    nepoch = -1
    moddir=os.getcwd()+'/trained_model/ctc/'
    ...
    for step in range(nepoch + 1, total_epoch):
        ...
        total_loss = train(model, data_loader, optimizer, clip)
